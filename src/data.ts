...
export const SNEAKER_PRODUCTS: Product[] = [
...

  {
    ...
    isHot: true,
    description:
      "Las On Running Cloudrunner combinan un diseño elegante en color negro con la tecnología CloudTec para una amortiguación excepcional. Su estructura resistente y malla transpirable brindan estabilidad y confort duradero en cada kilómetro de tu rutina diaria.",
  },

  {
    id: "adidas-adistar-verde",
    name: "Adidas Adistar",
    brand: "Adidas",
    category: "Deportivo",
    gender: "Caballero",
    ...
    sizes: [40, 41, 42, 43, 44],
    colors: ["Verde"],
    image: "/productos/hombre/adistar-verde.webp",
    rating: 4.9,
    isNew: true,
    isHot: true,
    description:
      "Las Adidas Adistar destacan por su estructura robusta y entresuela de alto rendimiento que brinda una amortiguación excepcional. Su diseño en tonos verde oscuro con detalles en contraste blanco y lima ofrece estabilidad y confort superior en tus sesiones de entrenamiento.",
  },
...

  {
    ...
    image: "/productos/unisex/new_balance_9060_beige.webp",
    images: ["/productos/unisex/new_balance_9060_negras.webp"],
    colorImages: {
      "Gris Nube": "/productos/unisex/new_balance_9060_beige.webp",
      Negro: "/productos/unisex/new_balance_9060_negras.webp",
    },
    rating: 4.7,
    isNew: true,
    description:
...

  {
    ...
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Azul Negro"],
    image: "/productos/unisex/jordan-azul-negro-unisex.webp",
    images: [
      "/productos/unisex/jordan-azul-negro-unisex.webp",
      "/productos/unisex/jordan-azul-neg.webp",
    ],
    rating: 4.9,
    isNew: true,
    description:
      "Este calzado resalta por su caña alta y exterior de gamuza en bloques de color azul y negro. Cuenta con una suela de goma plana que te ofrece tracción firme y un cuello acolchado que asegura soporte y comodidad continua en tu rutina diaria.",
  },

  {
    id: "jordan-1-tie-dye",
    name: "Air Jordan 1 High Tie-Dye",
    brand: "Jordan",
    category: "Urbano",
    gender: "Unisex",
    price: 185000,
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Azul Tie-Dye"],
    image: "/productos/unisex/jordan-retro.webp",
    images: ["/productos/unisex/jordan-retro.webp"],
    rating: 4.9,
    isNew: true,
    description:
      "Este calzado resalta por su caña alta y exterior de cuero con paneles en estampado tie-dye azul y verde. Cuenta con detalles en blanco y negro sobre una suela plana que te proporciona tracción firme y confort continuo durante tu uso diario.",
  },

  {
    id: "adidas-badbo-rise-1.0-unisex",
    name: "Adidas Bad Bunny Rise 1.0",
    brand: "Adidas",
    category: "Urbano",
    gender: "Unisex",
    price: 200000,
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Negro", "Blanco Negro", "Café Blanco", "Beige"],
    image: "/productos/unisex/badbo-negras.webp",
    images: [
      "/productos/unisex/badbo-negras.webp",
      "/productos/unisex/badbo-negras-atras.webp",
      "/productos/unisex/badbo-beig-negr-unisex.webp",
      "/productos/unisex/badbo-beig-negr-atras.webp",
      "/productos/unisex/badbo-caf-unisex.webp",
      "/productos/unisex/badbo-caf-unisex-atras.webp",
      "/productos/unisex/badbo-beig-unisex.webp",
      "/productos/unisex/badbo-beig-unisex-atras.webp",
    ],
    colorImages: {
      Negro: "/productos/unisex/badbo-negras.webp",
      "Blanco Negro": "/productos/unisex/badbo-beig-negr-unisex.webp",
      "Café Blanco": "/productos/unisex/badbo-caf-unisex.webp",
      Beige: "/productos/unisex/badbo-beig-unisex.webp",
    },
    rating: 4.9,
    isNew: true,
    description:
      "Las Adidas Bad Bunny Rise 1.0 combinan paneles de gamuza y detalles sintéticos en su exterior. Cuentan con una suela de caucho que te ofrece tracción firme y un interior acolchado que asegura soporte y comodidad en tu uso diario.",
  },

  {
    ...
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Gris Claro"],
    image: "/productos/unisex/puma-180-unisex.webp",
    images: [
      "/productos/unisex/puma-180-unisex.webp",
      "/productos/unisex/puma-180-unisex-t.webp",
    ],
    colorImages: {
      "Gris Claro": "/productos/unisex/puma-180-unisex.webp",
    },
    rating: 4.9,
    isNew: true,
    description:
      "Las Puma 180 presentan una estructura ancha y acolchada. Combinan gamuza y tela en tonos grises claros sobre una entresuela gruesa que amortigua tus pasos y te asegura comodidad constante durante tu uso diario.",
  },

  {
    ...
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Gris Plata"],
    image: "/productos/unisex/nike-p6000-unisex.webp",
    images: ["/productos/unisex/nike-p6000-unisex.webp"],
    colorImages: {
      "Gris Plata": "/productos/unisex/nike-p6000-unisex.webp",
    },
    rating: 4.9,
    isNew: true,
    description:
      "Las Nike P-6000 combinan malla transpirable con revestimientos sintéticos en tono plateado. Su diseño retro inspirado en el calzado de running de los años 2000 integra una entresuela de espuma que absorbe los impactos y te ofrece amortiguación constante en tu uso diario.",
  },
  {
    id: "adidas-superstar-clasicas",
    ...
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Blanco Negro"],
    image: "/productos/unisex/superstar-clasicas.webp",
    images: ["/productos/unisex/superstar-clasicas.webp"],
    colorImages: {
      "Blanco Negro": "/productos/unisex/superstar-clasicas.webp",
    },
    rating: 4.9,
    isNew: true,
    description:
      "Las Adidas Superstar incorporan un exterior sintético con la característica puntera de goma con relieve. Tienen una suela de caucho resistente que te ofrece tracción y soporte firme durante tu jornada.",
  },
  {
    id: "puma-suede-xl",
    name: "Puma Suede XL",
    ...
    sizes: [36, 37, 38, 39, 40, 41, 42, 43, 44],
    colors: ["Negro Blanco"],
    image: "/productos/unisex/suede-xl-unisex.webp",
    images: ["/productos/unisex/suede-xl-unisex.webp"],
    colorImages: {
      "Negro Blanco": "/productos/unisex/suede-xl-unisex.webp",
    },
    rating: 4.9,
    isNew: true,
    description:
      "Las Puma Suede XL presentan un exterior de gamuza negra con la franja lateral blanca. Tienen cuello acolchado y cordones gruesos que te ofrecen un ajuste firme. Su suela ancha de goma te asegura tracción y confort constante en tu uso diario.",
  },
];
